...
drop_na(dat) %>%
  ...
  geom_text(aes(label=scales::percent(valeur, accuracy=1, decimal.mark=",")),
            position=position_dodge(.9),
            hjust=-0.2, size=3) +
  labs(y="", x="Proportion des répondant·es n'ayant jamais testé la visio ou l'audioconférence",
       title="Usages de la visioconférence ou de l'audioconférence jugés adaptés, du point de vue des personnes ne les ayant jamais testés") +
  source_champ()
