...
# Pratiques personnes et celles des laboratoires
...
## Achats superflus avec un reliquat de budget
...
## Vols pour les conférences : évolution des émissions de gaz à effet de serre 
...
Les répondant·es ont été interrogé·es sur la visioconférence et l'audioconférence. Par soucis de concision, le terme visioconférence regroupe ci-dessous la visioconférence et l'audioconférence.
...
ggplot(drop_na(climat, visioavtconf),
  ...
  geom_text(aes(label=scales::percent(..prop.., accuracy=0.1, decimal.mark=",")),
            stat="count", position=position_dodge(.9),
            hjust=-0.2, size=3) +
  labs(x="Proportion des répondant·es", y="", title="Avant le confinement quel était votre usage habituel de la visioconférence ou de l’audioconférence 
...
ggplot(drop_na(climat, visioapresconf),
  ...
  geom_text(aes(label=scales::percent(..prop.., accuracy=1, decimal.mark=",")),
            stat="count", position=position_dodge(.9),
            hjust=-0.2, size=3) +
  labs(x="Proportion des répondant·es", y="", title="Depuis le confinement, votre expérience vous a-t-elle rendu·e plus favorable ou moins favorable 
       à la visioconférence ou l’audioconférence ?") +
...
# Réduction des émissions dans la recherche : les solutions concrètes
...
## Réductions individuelles des émissions dans le cadre professionnel d'ici à 2030
