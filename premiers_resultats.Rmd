...
## Part de la distrance totale parcourue en avion par les répondant·es correspondant selon la durée du trajet en train correspondant (estimation)
...
ggplot(TpsTransportDomT,  aes(x=prop, y=fct_reorder(TypeTransport, prop) )) +
  ...
  labs(y="",
       ...
       par tous les répondant·es, par mode de transport") 
```
