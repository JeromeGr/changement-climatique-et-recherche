...
informatique$TypeOrdi[informatique$TypeOrdi=="ordis.partage"]<-"Ordis partagés au laboratoire"
informatique$TypeOrdi[informatique$TypeOrdi=="ordis.fixepro"]<-"Ordis fixes individuels achetés avec des financements pros"
informatique$TypeOrdi[informatique$TypeOrdi=="ordis.fixeperso"]<-"Ordis fixes individuels achetés achetés par vous"
informatique$TypeOrdi[informatique$TypeOrdi=="ordis.portablepro"]<-"Ordis portables individuels achetés avec des financements pros"
informatique$TypeOrdi[informatique$TypeOrdi=="ordis.portableperso"]<-"Ordis portables individuels achetés par vous"
informatique$TypeOrdi[informatique$TypeOrdi=="ordis.tablettepro"]<-"Tablettes achetées avec des financements pros"
informatique$TypeOrdi[informatique$TypeOrdi=="ordis.tabletteperso"]<-"Tablettes achetées par vous"


informatique$set[informatique$set=="nb"]<-"Tous ordis/tablettes"
informatique$set[informatique$set=="5ans"]<-"De moins de 5 ans"
informatique$set[informatique$set=="indisp"]<-"Jugé(e)s indispensables"
...
ggplot(drop_na(climat, vols2ans),
  ...
  geom_text(aes(label=scales::percent(..prop.., accuracy=1, decimal.mark=",")),
            stat="count", position=position_dodge(.9),
            hjust=-0.2, size=3) +
  labs(x="Proportion des répondant·es n'ayant pas pris l'avion en 2019", y="Nombre d'heures de vol 2017 et 2018")
```
