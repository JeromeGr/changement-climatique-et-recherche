...
selon le temps travaillé sur place") +
  source_champ(extra="Lecture : sur 100 vols professionnels, 5 correspondaient à un séjour de plus d'un mois.")
...
ggplot(DFNbJourTravailles,  aes(x=prop, y=volsjours )) +
  ...
  labs(y="", x="Part du total des distances parcourues en avion",
       ...
       selon le temps travaillé sur place") +
  source_champ(extra="Lecture : sur 100 km parcourus en avion, 12 km l'ont été pour des séjours de plus d'un mois.")
```
...
ggplot(DFDistAvion,  aes(x=prop, y=fct_reorder(volsmotif, prop) )) +
  ...
  source_champ(extra="Lecture : sur 100 vols professionnels, 40 avaient pour motif une présentation dans une conférence.")
...
ggplot(DFDistAvion,  aes(x=prop, y=fct_reorder(volsmotif, prop) )) +
  ...
  source_champ(extra="Lecture : sur 100 km parcourus en avion, 43 km l'ont été pour une présentation dans une conférence.")
...
ggplot(DFDistMoyAvion,  aes(x=DistMoy, y=fct_reorder(volsmotif, DistMoy) )) +
  ...
  source_champ(extra="Lecture : en moyenne, les vols liés au terrain ou au recueil de données font 10 400 km (aller-retour).")
...
ggplot(DFDistAvion,  aes(x=prop, y=fct_reorder(volstrain, prop) )) +
  ...
  source_champ(extra="0,2% des émissions de gaz à effet de serre des vols correspondent à des déplacements\nqui auraient pu être réalisés en moins de 3h de train.")
