...
ggplot(raisons, aes(x=prop, y=fct_reorder(TypeRaison, prop))) +
  ...
  labs(y="", x="Proportion des répondant·es concerné·es",
...
## Réductions individuelles des émissions des dispositifs expérimentaux d'ici à 2030
...
## Risques liés à la réduction des émissions carbone des dispositifs expérimentaux
...
drop_na(dat) %>%
    ...
    theme(legend.position="bottom") +
    guides(fill=guide_legend(reverse = TRUE, nrow=2, byrow=TRUE)) +
    labs(y="Proportion des répondant·es utilisant un dispositif expérimental", x="",
