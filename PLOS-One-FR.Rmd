...
boot::norm.ci(boot::boot(climat_recherche,
                         function(data, inds) mean(data$volsdist_totconf[inds], na.rm=TRUE)/mean(data$volsdist_tot[inds], na.rm=TRUE), 10000))
boot::norm.ci(boot::boot(climat_recherche,
                         function(data, inds) mean(data$volsdist_totterrain[inds], na.rm=TRUE)/mean(data$volsdist_tot[inds], na.rm=TRUE), 10000))
boot::norm.ci(boot::boot(climat_recherche,
                         function(data, inds) mean(data$volsdist_totsejrech[inds], na.rm=TRUE)/mean(data$volsdist_tot[inds], na.rm=TRUE), 10000))
```
...
chisq.test(table(climat$discipline_agr4, climat$solrisqreducavion.qual)[, levels(climat$solrisqreducavion.qual) != "Non concerné·e"])
chisq.test(table(climat$discipline_agr4, climat$solrisqreducavion.donnees)[, levels(climat$solrisqreducavion.donnees) != "Non concerné·e"])

chisq.test(table(climat$sitpro_reduite, climat$solrisqreducavion.diffusion)[, levels(climat$solrisqreducavion.diffusion) != "Non concerné·e"])
chisq.test(table(climat$sitpro_reduite, climat$solrisqreducavion.isoler)[, levels(climat$solrisqreducavion.isoler) != "Non concerné·e"])
```
