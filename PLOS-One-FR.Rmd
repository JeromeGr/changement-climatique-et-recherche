...
library(car)
summary(lm(volsdist_tot ~ C(discipline_agr4, "contr.Sum"), climat_recherche))
TukeyHSD(aov(volsdist_tot ~ discipline_agr4, climat_recherche))
```
...
summary(lm(volsdist_tot ~ sitpro_reduite, climat_recherche))
TukeyHSD(aov(volsdist_tot ~ sitpro_reduite, climat_recherche))
```
