...
DFDistAvion<- climat %>% 
  ...
  pivot_longer(everything(),
               names_to = c(".value", "set"),
               names_sep = -1) 
#On regarde Volh<2 car c'est le temps pour l'aller retour. On maximise en disant que jusqu'à une heure, on a un train de moins de 3h
