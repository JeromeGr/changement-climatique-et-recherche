...
knitr::kable(round(lprop(table(climat$sitpro_reduite, climat$acthum3))))
```
...
climat_recherche <- subset(climat, ! sitpro_reduite %in% c(
...
tableaupct = 100*tableau[,2:7]/tableau[,8]
