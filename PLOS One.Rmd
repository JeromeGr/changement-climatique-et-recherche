...
knitr::kable(round(
  cbind("Diminuer la qualité de vos travaux"=lprop(table(climat$discipline_agr4, climat$solrisqreducavion.qual)[, levels(climat$solrisqreducavion.qual) != "Non concerné·e"], drop = F)[,"C'est probable et c'est un problème"],
        "Vous gêner pour l’accès à certains terrains\nou la collecte/production de certaines données"=lprop(table(climat$discipline_agr4, climat$solrisqreducavion.donnees)[, levels(climat$solrisqreducavion.donnees) != "Non concerné·e"], drop = F)[,"C'est probable et c'est un problème"]
  )))

knitr::kable(round(
  cbind("Isoler la recherche française\ndu reste du monde"=lprop(table(climat$sitpro_reduite, climat$solrisqreducavion.isoler)[, levels(climat$solrisqreducavion.isoler) != "Non concerné·e"], drop = F)[,"C'est probable et c'est un problème"],
