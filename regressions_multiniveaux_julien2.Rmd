...
```{r}
reg0 <- glmmTMB(volshnum ~ sexe + ageAgr + sitpro2 + 
...
library(ggeffects)
mydf <- ggpredict(reg2, terms = c("ScoreEcoloACP [quart2]", "ScoreInternational_pro_disc [-0.67, 0.13, 0.98]"))
