...
vars_centrer <- c("nbpublis2", "nbpublis2_log", "ScoreEcolo", "ScoreEcoloACP",
                  "ScoreInternational", "ScoreInternational_perso",
                  "ScoreInternational_pro", "ScoreInternational_pro2", "tourisme",
...
climatRegr_r <- group_by(climatRegr_r, unite.labintel) %>%
    ...
    ungroup()
# et des variables centrées par labo (_clabodisc) à l'intérieur des disciplines
