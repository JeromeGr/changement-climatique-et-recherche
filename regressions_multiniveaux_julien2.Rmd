...
vars_centrer <- c("nbpublis2", "ScoreEcolo", "ScoreEcoloACP",
                  ...
                  "revenuTete", "revenuMenage", "paienum", "parbacp5", "enfants_foyer", "un_parent_publicnum", "enfant_moins_5_ansnum")
...
```{r}
reg0 <- glmmTMB(volshnum ~  sexenum + ageAgr + sitpro2 +
                    ScoreEcoloACP + ScoreEcoloACP_labo + ScoreEcoloACP_disc +
                   revenuTete + revenuTete_labo + revenuTete_disc +
                   #revenuMenage + revenuMenage_labo + revenuMenage_disc +
                  # couple1 + couple1_labo + couple1_disc+
                  # parbacp5 + parbacp5_labo +parbacp5_disc+
                  # un_parent_publicnum+ un_parent_publicnum_labo + un_parent_publicnum_disc +
...
reg1 <- update(reg0, ~ . +
                 ...
                 # enfant_moins_5_ansnum + enfant_moins_5_ansnum_labo + enfant_moins_5_ansnum_disc+
...
# 
# representation effets interactions
