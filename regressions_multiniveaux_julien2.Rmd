...
vars_centrer <- c("nbpublis2", "nbpublis2_log", "coauteur", "coauteur_hal",
...
vars <- c(vars_centrer, "sexenum", "carrierenum", "carriere_titnum", "carriere_precnum", "couple1",
          "rangAnum", "titnum", "agenum", "respprojetnum", "idfnum", "loinnum",
...
reg0 <- glmmTMB(volshnum ~ sexenum + sexenum_labo + sexenum_disc +
                    ...
                    nbpublis2 + nbpublis2_labo + nbpublis2_disc + coauteur_hal +
